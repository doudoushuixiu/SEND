...
INT8U PaTabel[8] = {0xC1 ,0xC1 ,0xC1,0xC1 ,0xC1 ,0xC1 ,0xC1 ,0xC1};   //10dBm     功率最大
...
const RF_SETTINGS rfSettings = 
{
    ...
    0x23,   // FREQ2     Frequency control word, high byte.   for 915M
    0x31,   // FREQ1     Frequency control word, middle byte. for 915M
    0x3B,   // FREQ0     Frequency control word, low byte.    for 915M
    ...
    0x1F,   // FSCAL0    Frequency synthesizer calibration.  for 915M
...
main()
{
        INT8U leng =8;        // 8字节, 如果需要更长的数据包,请正确设置	
        
        INT8U dispaly[8]={0x7,0x7,0x7,0x7,0x7,0x7,0x7,0x7};
